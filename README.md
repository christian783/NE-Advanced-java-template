...
```
java -Dspring.profiles.active=production -jar ./target/myApp-0.0.1-SNAPSHOT.jar
```
...
```
mvnw spring-boot:build-image -Dspring-boot.build-image.imageName=io.app/my-app
```
